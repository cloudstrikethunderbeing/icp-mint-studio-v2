import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, h as reactDomExports, b as useNavigate, a as useAuth, d as useQueryClient, i as useNotifications, L as LoaderCircle, I as Info, X, k as ue, T as TriangleAlert, E as ExternalBlob } from "./main-BjOk3k__.js";
import { d as Portal$1, h as hideOthers, u as useFocusGuards, e as ReactRemoveScroll, F as FocusScope, f as DismissableLayer, N as NftDetailModal, j as Dialog, k as DialogContent, l as DialogHeader, m as DialogTitle, n as DialogDescription, o as DialogFooter } from "./NftDetailModal-CJ377HmB.js";
import { B as Button } from "./button-B4CQ5ZgR.js";
import { d as Primitive, g as useControllableState, h as useId, c as composeEventHandlers, i as useLayoutEffect2, u as useCallbackRef, b as createContextScope, f as createSlot, P as Presence } from "./index-DyLQm6pg.js";
import { u as useComposedRefs, c as cn } from "./utils-CBQGxPqG.js";
...
import { R as Root2$1, A as Anchor, c as createPopperScope, C as Content, a as Arrow, P as Plus } from "./index-BDS3QAN8.js";
import { u as usePrevious, C as ChevronDown, a as ChevronUp } from "./index-Bjt6qTDy.js";
import { S as Skeleton } from "./skeleton-B7T9qvbA.js";
import { h as useCreateSlot, u as useMyActiveNfts, i as useSearchNfts, j as useGenerateClaimLink, k as useMutation } from "./useQueries-D2VJ19-u.js";
...
function UploadCard({
  ...
  const tierMax = reactExports.useMemo(() => {
    if (isAdmin) return 500;
    return 1;
  }, [isAdmin]);
  const [supplyLimit, setSupplyLimit] = reactExports.useState(tierMax);
  const [supplyLimitStr, setSupplyLimitStr] = reactExports.useState(
    tierMax.toString()
  );
  reactExports.useEffect(() => {
    if (mintDialogOpen) {
          ...
          DialogContent,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "mint-supply", children: "Edition Size" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "mint-supply",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: isAdmin ? "Max 500 (admin)" : `Max ${tierMax} for your tier` })
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    type: "button",
                    onClick: handleMint,
                    disabled: !title.trim() || isMinting || !isAuthenticated || !actor,
...
function HomePage() {
  ...
  const mintMutation = useMutation({
    ...
    onSuccess: (result) => {
      ...
      if (isAdmin && nftUniqueId && (ok == null ? void 0 : ok.id) !== void 0) {
  ...
  const unclaimedNfts = reactExports.useMemo(
    () => (displayNfts ?? []).filter((nft) => !nft.claimedAt),
    [displayNfts]
  );
  const stableNfts = reactExports.useMemo(() => unclaimedNfts, [unclaimedNfts]);
