...
function SettingsPage() {
  ...
  const [adminPidInput, setAdminPidInput] = reactExports.useState("");
  const [adminPidError, setAdminPidError] = reactExports.useState("");
  ...
  const adminPrincipalQuery = useQuery({
    ...
    // admin principal never changes
  });
  const adminConfigured = adminPrincipalQuery.data !== null && adminPrincipalQuery.data !== void 0;
  ...
  const canisterIdDisplay = canisterIdQuery.isLoading ? "Loading..." : canisterIdQuery.data && canisterIdQuery.data.trim().length > 0 ? canisterIdQuery.data : "Unavailable";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        !adminConfigured && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-card border border-border rounded-xl p-4 space-y-3",
            ...
            children: [
              ...
              adminPrincipalQuery.isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground animate-pulse", children: "Checking admin status..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "settings.admin_unconfigured", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg bg-amber-500/10 border border-amber-500/20 px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-400 font-medium", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-4 h-4 mr-1" }),
                  "No admin set. Enter your Principal ID below to claim admin permanently. This can only be done once."
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Label,
                    {
                      ...
                      children: "Admin Principal ID"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70", children: "Paste your full ICP Principal ID (visible in your Profile page)." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "admin-pid-input",
                  ...
                  adminPidError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-xs text-destructive",
                      "data-ocid": "settings.admin_pid_field_error",
                      children: adminPidError
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: setAdminMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    isAdminLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-muted-foreground animate-pulse", children: "Loading..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-semibold", children: roleDisplay }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: subscriptionDisplay })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    ...
                    children: isAdmin ? roleDisplay : subscriptionDisplay
                  }
                )
              ]
            }
        ...
        ] }) : isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "settings.admin_panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-card border border-border rounded-xl p-4 space-y-3",
