import { c as createLucideIcon, r as reactExports, i as reactDomExports, j as jsxRuntimeExports, u as useComposedRefs, a as cn, B as Button, L as LoaderCircle, z, d as useAuth, f as useQueryClient, g as useQuery, k as useNotifications, T as TriangleAlert, I as Info, E as ExternalBlob } from "./index-C9MKyHwp.js";
import { n as Portal$1, o as hideOthers, u as useFocusGuards, p as ReactRemoveScroll, F as FocusScope, q as DismissableLayer, d as Dialog, g as DialogContent, h as DialogHeader, i as DialogTitle, j as DialogDescription, m as Trash2, f as Plus, k as Textarea, l as DialogFooter } from "./textarea-2b4gyuvS.js";
import { I as Input } from "./input-C9Z1-ixA.js";
import { L as Label } from "./label-zgvlRdbO.js";
import { u as useNftDetailQuery, a as useUpdateMetadata } from "./useQueries-BQPCBTb3.js";
import { C as Check, a as Copy } from "./copy-hToGQ4qr.js";
import { P as Primitive, u as useLayoutEffect2, b as createContextScope, d as useCallbackRef, e as useControllableState, f as useId, c as composeEventHandlers, g as createSlot, h as Presence } from "./index-DNcLgC-N.js";
import { u as useDirection, c as createCollection, C as ChevronDown, a as ChevronUp } from "./index-I2Akdcna.js";
import { S as Skeleton } from "./skeleton-C6h9J8B3.js";
import { u as useMutation } from "./useMutation-TMkDmjUs.js";
import { u as ue, L as Lock } from "./index-Bz8oZrta.js";
...
function NftDetailModal({
  ...
  const [showBurnConfirm, setShowBurnConfirm] = reactExports.useState(false);
  ...
  const mintDate = new Date(Number(nft.mintDate) / 1e6).toLocaleString();
  function canEditMetadata() {
    var _a;
    if (!nft) return false;
    const ownerId = ((_a = nft.ownerId) == null ? void 0 : _a.toString()) ?? "";
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(MetaRow, { label: "Minted", value: mintDate }),
                nft.description && /* @__PURE__ */ jsxRuntimeExports.jsx(MetaRow, { label: "Description", value: nft.description }),
                nft.collectionId !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  MetaRow,
                  {
                    label: "Collection ID",
              ...
              canEditMetadata() && !showEdit && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  type: "button",
                  variant: "outline",
              ...
              !showBurnConfirm ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  type: "button",
                  variant: "ghost",
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600 font-bold", children: "Permanent Destruction" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        id: "burn-confirm-description",
                        className: "text-sm text-red-600 font-medium",
                        children: "This will permanently destroy the NFT. It cannot be recovered or verified again."
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          children: isBurning ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : "Burn"
                        }
                      )
                    ] })
                  ]
...
function UploadCard({
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "text-primary/60 text-lg" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground text-center leading-tight", children: "Connect to mint" })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        type: "button",
        className: `aspect-square rounded-xl border-2 border-dashed transition-colors duration-200 flex flex-col items-center justify-center gap-1.5 p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary ${dragOver ? "border-primary bg-primary/10" : "border-primary/50 bg-primary/5 hover:border-primary hover:bg-primary/10"}`,
        onClick: () => {
          var _a;
        ...
        children: isMinting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin text-primary text-lg" }),
...
function HomePage() {
  ...
  const mintMutation = useMutation({
    ...
    onSuccess: (result) => {
      ...
      const tokenIdStr = tokenId !== void 0 && tokenId !== 0n ? tokenId.toString() : void 0;
      ...
      ue.success(
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: tokenIdStr ? `Token ID: ${tokenIdStr} minted successfully!` : "NFT minted successfully!" }),
          nftUniqueId && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
            "Unique ID: ",
            nftUniqueId
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    onError: (err) => {
      ue.error(err.message || "Mint failed");
      addNotification({
        type: "critical",
        title: "Mint Failed",
  ...
  const deleteMutation = useMutation({
    ...
    onMutate: () => {
      ue.loading("Deleting NFT...", { id: "delete-toast" });
    },
    onSuccess: () => {
      ue.success("NFT deleted", { id: "delete-toast" });
      setSelectedNft(null);
      queryClient.invalidateQueries({ queryKey: ["myActiveNfts"] });
    },
    onError: (err) => {
      ue.error(err.message || "Delete failed", { id: "delete-toast" });
    }
  });
  const burnMutation = useMutation({
    ...
    onMutate: () => {
      ue.loading("Burning NFT...", { id: "burn-toast" });
    },
    onSuccess: () => {
      ue.success("NFT burned permanently", { id: "burn-toast" });
      setSelectedNft(null);
      queryClient.invalidateQueries({ queryKey: ["myActiveNfts"] });
      queryClient.invalidateQueries({ queryKey: ["slotsStatus"] });
    },
    onError: (err) => {
      ue.error(err.message || "Burn failed", { id: "burn-toast" });
    }
  });
  const gridSlots = reactExports.useMemo(() => buildGrid(nfts.slice(0, MAX_NFTS)), [nfts]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 p-3 max-w-xl mx-auto w-full pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center gap-3 py-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: "Mint. Own. Verify." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "The easiest way to create and verify NFTs on the Internet Computer." })
      ] }),
      !isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Fingerprint, { className: "mr-2" }),
            "Start Minting"
          ]
        }
      )
    ...
    isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Start Here" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                onClick: () => {
                  var _a2;
                  return (_a2 = document.querySelector('[data-ocid="home.upload_card"]')) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth", block: "center" });
                },
    ...
    isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground -mt-2", children: "NFTs are organized by Slots (Collections)" }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", "data-ocid": "home.loading_state", children: Array.from({ length: 9 }).map((_, i) => (
      // biome-ignore lint/suspicious/noArrayIndexKey: static skeleton
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "aspect-square rounded-xl" }, i)
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", "data-ocid": "home.grid", children: gridSlots.map((slot, i) => {
    ...
    isAuthenticated && !isLoading && slotsStatus && Number(slotsStatus.used) > 0 && nfts.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "text-yellow-300 mt-0.5 text-sm" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-300 leading-relaxed", children: "State mismatch detected — backend slot state is inconsistent. No NFTs found. Please contact support if this persists." })
        ]
      }
    ),
    !isAuthenticated && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "p",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "mr-1 inline" }),
