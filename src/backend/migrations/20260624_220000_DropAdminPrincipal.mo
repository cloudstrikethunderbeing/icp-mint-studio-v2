...
module {
  ...
  // ── OldActor = NewActor of 20260624_210500_ResyncMasterAdminRoles ────────
  ...
  // ── NewActor: adminPrincipal removed ─────────────────────────────────────
  ...
  public func migration(old : OldActor) : NewActor {
    // Drop adminPrincipal — AccessControl is the single source of truth.
    {
